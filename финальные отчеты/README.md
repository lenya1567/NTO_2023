...
```python3
numpy # Для работы с OpenCV
rospy # Для работы с коптером
opencv # Для компьютерного зрения
requests # Для GET запроса на сервер организаторов
```

Кроме того для визуализации была использользована ROS3DJS.
